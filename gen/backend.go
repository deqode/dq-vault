...
`,
			...
			&framework.Path{
				...
				HelpDescription: "generates a signature given tx, pvt and pub keys",
				Fields: map[string]*framework.FieldSchema{
					"txid": &framework.FieldSchema{
						Type: framework.TypeString,
						Description: "the transaction id",
						Default: "addfgqwr34235rdfa",
					},
					"pvtkey": &framework.FieldSchema{
						Type: framework.TypeString,
			...
			&framework.Path{
				Pattern: "store",
				HelpSynopsis: "stores key",
				HelpDescription: "stores",
				Fields: map[string]*framework.FieldSchema{
					"pvtkey": &framework.FieldSchema{
						Type: framework.TypeString,
						Description: "the private key",
				...
				Callbacks: map[logical.Operation]framework.OperationFunc{
					logical.UpdateOperation: b.storeKey,
			...
			/*&framework.Path{
				Pattern:      "stored",
				HelpSynopsis: "Display information about this plugin fafffa",
				HelpDescription: `

Displays information about the plugin, such as the plugin version and where to
get help. fadsfggaafsaf
